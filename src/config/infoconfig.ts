  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Workspaces page allows you to manage your workspaces and switch between them. You can view all available workspaces, create new ones, and switch your active workspace.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'Server-side permission checks ensure that users can only access resources for their active organization.',
      links: []
    }
  ]
};
...
export const teamInfoContent: InfobarContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      description:
        'Roles define what actions team members can perform within the workspace. Common roles include admin, member, and custom roles you define.',
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'The application includes a client-side navigation filtering system. It supports `requireOrg`, `permission`, and `role` checks for access control. Navigation items are configured in `src/config/nav-config.ts` with `access` properties.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        "The Billing page allows you to manage your organization's subscription and usage limits.",
      links: []
    },
    {
    ...
    },
    {
      ...
      description:
        'Plans and features are used for access control throughout the application.',
      links: []
    }
  ]
};
