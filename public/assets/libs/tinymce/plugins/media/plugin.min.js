!(function () {
  ...
  const N = (e, t = {}) =>
    ...
    W = (e, t) => {
      const r = A.extend({}, t);
      if (!r.source && (A.extend(r, z(r.embed ?? '', e.schema)), !r.source))
        return '';
      r.altsource || (r.altsource = ''),
        r.poster || (r.poster = ''),
      ...
      const r =
        ...
        a = ((e, t, r) => (a) => {
          ...
          return {
            [a]: (a === r
              ? s().bind((e) =>
                  o(e) ? c(e).orThunk(i) : i().orThunk(() => n.from(e))
                )
